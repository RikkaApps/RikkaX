...
public class FastScroller extends ItemDecoration implements OnItemTouchListener {
    ...
    void updateScrollPosition(int offsetX, int offsetY) {
        ...
        if (mNeedVerticalScrollbar) {
            ...
            mVerticalThumbHeight = Math.max(mMinHeight, Math.min(verticalVisibleLength,
        ...
        if (mNeedHorizontalScrollbar) {
            ...
            mHorizontalThumbWidth = Math.max(mMinHeight, Math.min(horizontalVisibleLength,
