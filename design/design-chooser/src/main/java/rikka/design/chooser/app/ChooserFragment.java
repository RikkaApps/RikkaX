...
import rikka.core.app.ThemedDialogFragment;
import rikka.design.chooser.R;
import rikka.design.chooser.widget.ResolverDrawerLayout;

public class ChooserFragment extends ThemedDialogFragment {
